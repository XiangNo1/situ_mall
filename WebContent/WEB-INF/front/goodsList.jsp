		...
		<div class="box2">
        	...
        	<c:if test="${userSession != null }">
            	<li><a class="login">欢迎回来 ： ${userSession.username} </a>
            		<a  href="${ctx }/login/loginOut.shtml?redirectUri=/details/details1.shtml?id=${category.id }&parent_id=${category.parent_id }">退出登录</a>
            	</li>
        	</c:if>
        	
        	<c:if test="${userSession == null }">
            	<li><a class="login" href="${ctx }/login/login.shtml?redirectUri=/details/details1.shtml?id=${category.id }&parent_id=${category.parent_id }">请登录</a></li>
        	</c:if>
